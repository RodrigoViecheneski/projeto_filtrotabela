<?php
	try{
		$pdo = new PDO("mysql:dbname=projeto_filtroemtabelas;host=localhost","root", "root");
	}catch(PDOException $e){
		echo "ERRO: ".$e->getMessage();
		exit;
	}
	if(isset($_POST['sexo']) && $_POST['sexo'] != ''){
	//if(!empty($_POST['sexo'])){ esse if dá erro quando seleciona mais de 1 vez por causa do 0 significa null
		$sexo = $_POST['sexo'];
